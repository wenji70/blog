/*
 ...
 Source Schema         : bolg_system

 Target Server Type    : MySQL
 Target Server Version : 80044 (8.0.44)
 File Encoding         : 65001

 Date: 20/12/2025 18:03:59
*/
...
CREATE TABLE `t_authority`  (
  `id` int NULL DEFAULT NULL,
  `authority` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
CREATE TABLE `t_categories`  (
  ...
  `categoriesName` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `t_categories` VALUES (0, '未分类');
INSERT INTO `t_categories` VALUES (1, '技术');
INSERT INTO `t_categories` VALUES (2, '教学');
INSERT INTO `t_categories` VALUES (5, '学习');
...
CREATE TABLE `t_comment`  (
  ...
  `created` date NULL DEFAULT NULL,
  `ip` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
  `content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
  `status` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
...
INSERT INTO `t_comment` VALUES (NULL, 12, '2025-12-20', '0:0:0:0:0:0:0:1', '真不错太有趣了\r\n\r\n', NULL, 'tom');
...
INSERT INTO `t_statistic` VALUES (12, 12, 45, 2);
...
CREATE TABLE `t_user`  (
  `id` int NULL DEFAULT NULL,
  `username` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
